...
/**
 * A Java implementation of Rust's <code>Result[T, E]</code> type, or Scala's <code>Either[A, B]</code>.
 *
...
public final class Result<T, E> {
    ...
    public boolean equals(Object o) {
        ...
        return kind == result.kind && Objects.equals(error, result.error) && Objects.equals(ok, result.ok);
    }
